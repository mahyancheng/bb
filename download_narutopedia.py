#!/usr/bin/env python3
"""
Download all Narutopedia Fandom wiki pages as text and compile them into a single PDF.

Usage:
    python download_narutopedia.py [--output-dir OUTPUT_DIR]
"""
...
def parse_args(argv: List[str]) -> argparse.Namespace:
    ...
    parser.add_argument(
        "--output-dir",
        type=Path,
        default=Path("narutopedia_output"),
